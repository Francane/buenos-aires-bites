  ...
  return (
    ...
    >
      <div className="relative overflow-hidden aspect-[4/3]">
        ...
        <span className={`absolute top-3 left-3 px-2.5 py-1 rounded-full text-xs font-semibold glass ${venue.isOpen ? 'text-sage' : 'text-destructive'}`}>
          {venue.isOpen ? t.venues.open : t.venues.closed}
        </span>
      </div>
      <div className="p-5">
        ...
        <div className="flex items-center gap-1.5 mt-3.5 text-xs text-muted-foreground">
